...
-- Análisis de ingresos por servicio y su peso porcentual sobre el total
...
-- Ranking de servicios por ingresos dentro de cada país
SELECT
    c.Pais,
    s.Nombre AS Servicio,
    SUM(dr.CantidadContratada * dr.PrecioUnidad) AS Ingresos,
...
-- Análisis del "ticket medio" por país
SELECT
    c.Pais,
...
-- Comparativa entre volumen de contratación e ingresos por servicio
SELECT
    s.Nombre AS Servicio,
